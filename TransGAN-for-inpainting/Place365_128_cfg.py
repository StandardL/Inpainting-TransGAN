...
def parse_args():
    ...
    parser.add_argument(
        '--load_path',
        type=str,
        default='inpainting_test/mode_place365_deep_epoch7_mask_checkpoint',
        help='The reload model path')
    parser.add_argument(
        '--exp_name',
        type=str,
        default='places365_128',
    ...
    parser.add_argument(
        '--gen_model',
        type=str,
        default='Places128_gen',
        help='path of gen model')
    parser.add_argument(
        '--dis_model',
        type=str,
        default='Places128_dis',
    ...
    parser.add_argument('--optimizer', type=str, default="adam",
                        help='optimizer')
    parser.add_argument('--loss', type=str, default="wgangp-mode",
                        help='loss function')
    ...
    parser.add_argument('--g_depth', type=str, default="5,3,2,2,2",
    ...
    parser.add_argument('--patch_size', type=int, default=2,
                        help='Discriminator Depth')
    parser.add_argument('--fid_stat', type=str, default="fid_stat/fid_stats_Places365_train.npz",
                        help='Discriminator Depth')
    ...
    parser.add_argument('--mask_path', type=str,
                        default='./val_mask_128',
                        help='mask path')
    parser.add_argument('--mask_type', type=str, default='places',
    ...
    parser.add_argument("--mask_eps", type=float, default=0.1,
                        help="mask eps")

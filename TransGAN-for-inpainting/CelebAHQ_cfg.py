...
def parse_args():
    ...
    parser.add_argument('--loca_rank', default=-1, type=int,
                        help='node rank for distributed training')
    parser.add_argument('--dist-url', default='tcp://localhost:10641', type=str,
    ...
    parser.add_argument(
        '--load_path',
        type=str,
        default='cifar_checkpoint/celeba256_epoch10_mask_checkpoint',
    ...
    parser.add_argument('--df_dim', type=int, default=192,
                        help='The base channel num of disc')
    parser.add_argument(
        '--gen_model',
        type=str,
        default='Celeba256_gen_mask',
        help='path of gen model')
    parser.add_argument(
        '--dis_model',
        type=str,
        default='Celeba256_dis',
    ...
    parser.add_argument('--num_eval_imgs', type=int, default=2048)
    parser.add_argument(
        '--bottom_width',
        type=int,
        default=8,
    ...
    parser.add_argument('--rl_num_eval_img', type=int, default=3000,
    ...
    parser.add_argument('--optimizer', type=str, default="adam",
                        help='optimizer')
    parser.add_argument('--loss', type=str, default="wgangp-eps",
                        help='loss function')
    ...
    parser.add_argument('--g_depth', type=str, default="5,3,2,2,2,2",
                        help='Generator Depth')
    parser.add_argument('--g_norm', type=str, default="pn",
    ...
    parser.add_argument('--patch_size', type=int, default=2,
                        help='Discriminator Depth')
    parser.add_argument('--fid_stat', type=str, default="fid_stat/fid_stats_CelebAHQ256_train.npz",
                        help='Discriminator Depth')
    parser.add_argument('--diff_aug', type=str, default="filter,translation,erase_ratio,color,hue",
                        help='differentiable augmentation type')
    parser.add_argument('--accumulated_times', type=int, default=4,
                        help='gradient accumulation')
    parser.add_argument('--g_accumulated_times', type=int, default=4,
                        help='gradient accumulation')
    ...
    parser.add_argument("--mask_eps", type=float, default=0.01,
                        help="mask eps")
    parser.add_argument("--train_type", type=str, default='inpainting',
                        help="the task for training")
